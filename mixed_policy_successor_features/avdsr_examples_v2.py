"""
Reconstruction done off the psi representations as recommended by Blake. 
"""
...
class SRNetNatureUnsup(nn.Module):
    def __init__(self, output_dim, hidden_units_sr=(512*4,), hidden_units_psi2q=(), gate=F.relu, config=1):
        ...
        self.decoder = nn.Sequential(
            layer_init(nn.Linear(self.feature_dim * output_dim, 7 * 7 * 64)),
